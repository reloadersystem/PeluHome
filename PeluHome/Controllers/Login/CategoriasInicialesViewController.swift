//
//  CategoriasInicialesViewController.swift
//  PeluHome
//
...
class CategoriasInicialesViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "segueServicioInicial" {
            if let indexPath = tableViewCategorias.indexPathForSelectedRow {
                ...
                let objDestino = segue.destination as! ServiciosInicialesViewController
...
extension CategoriasInicialesViewController: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return categorias.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "celdaCategoriaInicial", for: indexPath) as! CategoriasTableViewCell
